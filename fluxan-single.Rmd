...
===================================================================
This script analyses the datalogger file from a _single_ experimental run, and summarises the results in the exported [cycle table](`r cycle_table_output_file `). The cycle tables from individual runs are designed to be combined to allow a complete experimental analysis to be performed once all the runs are complete. This can be done in a separate script or by import of the cycle tables to other analysis software.

Source code for this analysis can be found at https://github.com/davidelliott/fluxan .
